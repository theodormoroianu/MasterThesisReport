...
While our technique is a step forward in the direction of a complete and sound extraction of the DSG dependencies, it suffers from similar limitations as the original technique used by \textit{TxCheck}:
\begin{itemize}
