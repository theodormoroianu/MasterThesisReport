...
We then use the testbed to replicate and analyse a set of known bugs in the MySQL, MariaDB and TiDB DBMSs. We find that in the overwhelming majority of the replicated bugs, the isolation level does not have any impact, as bugs manifest under all isolation levels supported by the DBMS.
